...
class SecureEnvironmentManager:
    ...
    def check_environment_security():
        ...
        if sendgrid_key and ('test' in sendgrid_key.lower() or 'dev' in sendgrid_key.lower()):
...
def get_firebase_credentials() -> dict:
    ...
    return {
        ...
        'credentials_path': SecureEnvironmentManager.get_optional_env('GOOGLE_APPLICATION_CREDENTIALS', 'firebase_service_key.json')
    }
...
def get_sendgrid_config() -> dict:
    ...
    return {
        ...
        'sender_email': SecureEnvironmentManager.get_optional_env('SENDER_EMAIL', 'noreply@menteeglobal.org')
    }
